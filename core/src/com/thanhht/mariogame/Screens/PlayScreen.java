package com.thanhht.mariogame.Screens;
...
import com.thanhht.mariogame.Sprites.Items.ItemDef;
import com.thanhht.mariogame.Sprites.Items.Mushroom;
import com.thanhht.mariogame.Sprites.Mario;
import com.thanhht.mariogame.Tools.B2WorldCreator;
import com.thanhht.mariogame.Tools.WorldContactListener;
...
public class PlayScreen implements Screen {
    ...
    public void update(float dt){
        ...
        if(player.currentState != Mario.State.DEAD && player.b2body.getPosition().x > 2 && player.b2body.getPosition().x <= 35) {
    ...
    public boolean gameOver(){
        if(player.currentState == Mario.State.DEAD && player.getStateTimer() > 3 || player.b2body.getPosition().y <= -2){
            return true;
        }
        return false;
    }
